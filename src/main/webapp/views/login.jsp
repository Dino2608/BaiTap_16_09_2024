...
<html lang="en">
  ...
  <head>
    ...
    <link
      href="../../assets/frontend/layout/css/style-responsive.css"
      rel="stylesheet"
    />
    <link
      href="../../assets/frontend/layout/css/themes/red.css"
      rel="stylesheet"
      id="style-color"
    />
  ...
  <body class="corporate">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 additional-shop-info">
            <ul class="list-unstyled list-inline">
              ...
              <li>
                <i class="fa fa-envelope-o"></i><span>info@keenthemes.com</span>
              </li>
            </ul>
          </div>
          ...
          <div class="col-md-6 col-sm-6 additional-nav">
            <ul class="list-unstyled list-inline pull-right">
              ...
              <li><a href="<%=request.getContextPath()%>/regiter">Registration</a></li>
            </ul>
          </div>
          <!-- END TOP BAR MENU -->
        </div>
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href= "<%=request.getContextPath()%>/home"
          ><img
          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="<%=request.getContextPath()%>/home">Home Default</a></li>
                <li>
          ...
          <div class="sidebar col-md-3 col-sm-3">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              <li class="list-group-item clearfix">
                <a href="#"><i class="fa fa-angle-right"></i> Login/Register</a>
              </li>
              <li class="list-group-item clearfix">
                <a href="#"
                  ><i class="fa fa-angle-right"></i> Restore Password</a
                >
              </li>
              <li class="list-group-item clearfix">
              ...
              <li class="list-group-item clearfix">
                <a href="#"><i class="fa fa-angle-right"></i> Address book</a>
              </li>
              <li class="list-group-item clearfix">
                <a href="#"><i class="fa fa-angle-right"></i> Wish list</a>
              </li>
              <li class="list-group-item clearfix">
                <a href="#"><i class="fa fa-angle-right"></i> Returns</a>
              </li>
              <li class="list-group-item clearfix">
                <a href="#"><i class="fa fa-angle-right"></i> Newsletter</a>
              </li>
            </ul>
          </div>
          <!-- END SIDEBAR -->
              ...
              <div class="row">
                  ...
                  <form class="form-horizontal form-without-legend" role="form" method="post">
                    <div class="form-group">
                      <label for="username" class="col-lg-4 control-label"
                        >Username <span class="require">*</span></label
                      >
                      <div class="col-lg-8">
                ...
                <div class="col-md-4 col-sm-4 pull-right">
                  <div class="form-info">
                    ...
                    <p>
                      Duis autem vel eum iriure at dolor vulputate velit esse
                      vel molestie at dolore.
                    </p>
              ...
              <ul class="list-unstyled">
                <li>
                  <a href="#"
                    ><img
                      alt=""
                      src="../../assets/frontend/pages/img/people/img5-small.jpg"
                  /></a>
                </li>
                <li>
                  <a href="#"
                    ><img
                      alt=""
                      src="../../assets/frontend/pages/img/works/img1.jpg"
                  /></a>
                </li>
                <li>
                  <a href="#"
                    ><img
                      alt=""
                      src="../../assets/frontend/pages/img/people/img4-large.jpg"
                  /></a>
                </li>
                <li>
                  <a href="#"
                    ><img
                      alt=""
                      src="../../assets/frontend/pages/img/works/img6.jpg"
                  /></a>
                </li>
                <li>
                  <a href="#"
                    ><img
                      alt=""
                      src="../../assets/frontend/pages/img/works/img3.jpg"
                  /></a>
                </li>
                <li>
                  <a href="#"
                    ><img
                      alt=""
                      src="../../assets/frontend/pages/img/people/img2-large.jpg"
                  /></a>
                </li>
                <li>
                  <a href="#"
                ...
                <li>
                  <a href="#"
                    ><img
                      alt=""
                      src="../../assets/frontend/pages/img/works/img5.jpg"
                  /></a>
                </li>
                <li>
                  <a href="#"
    ...
    <script
      src="../../assets/frontend/layout/scripts/layout.js"
      type="text/javascript"
    ></script>
